$(function() {
    ...
    let collapse_html = "<td class='ccc-cell-fix'><a href='#' class='collapser-control'>[-]</a></td>";
    let expand_html = "<div class='expander-control-div thread-border' style='display:none;'><a href='#' class='expander-control'>[+]</a> &nbsp; ";
